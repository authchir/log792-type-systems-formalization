...
\begin{titlepage}
  \begin{center}
    ...
    \textsc{\Large Proposition de projet}\\[0.5cm]
...
simplement typé, qui a la propriété de pouvoir représenter la majorité des langages de programmation
existants\footnote{Ceci n'est pas tout à fait exact puisqu'il faudrait y ajouter la fonctionnalité
de pouvoir communiquer avec l'environnement d'exécution afin de pouvoir faire des opérations comme
lire ou écrire dans un fichier, effectuer de la communication interprocessus, etc.}.
